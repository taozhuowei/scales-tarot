  ...
  forbidden: [
    ...
    //   core/. tools/ is a dev-only sink consumed only by pages/.
    {
      ...
      comment:
        ...
        "on flows/ (UI components + composable orchestration) or pages/ " +
        "route entries. Dependencies flow downward into core/, never back " +
...
// generated: dependency-cruiser@17.3.10 on 2026-04-19T15:47:26.142Z
