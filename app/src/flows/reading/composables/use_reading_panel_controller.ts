...
export interface ReadingPanelViewModel {
  // Hero section
...
export function useReadingPanelController(props: UseReadingPanelControllerProps): ReadingPanelViewModel {
